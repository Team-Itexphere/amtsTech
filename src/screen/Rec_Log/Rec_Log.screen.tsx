...
const Rec_LogScreen = () => {
    ...
    const processImage = async (imageRes: resultAssets) => {
        ...
        try {
            ...
            console.error("catch handleCamera ImageCompressor Rec_Log View ::", error);
        ...
        setIsLoarding(false);
        if (!postRes) return console.error("Error in postImageCapture. Please  - Rec_Log  check.");
