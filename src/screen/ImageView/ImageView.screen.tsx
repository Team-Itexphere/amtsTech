...
const ImageViewScreen = () => {
    ...
    const processImage = async (imageRes: resultAssets) => {
        if (!cus_id) return console.warn("picture - cus_id -> null");
        ...
        try {
            ...
            console.error("catch handleCamera ImageCompressor picture View ::", error);
        ...
        setIsLoarding(false);
        if (!postRes) return console.error("Error in postImageCapture. Please  - picture  check.");
